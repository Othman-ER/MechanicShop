...
public static class ApplicationErrors
{
    public static Error WorkOrderOutsideOperatingHour(
        ...
        DateTimeOffset endAtUtc) => Error.Conflict(
    ...
    public static Error LaborOccupied => Error.Conflict(
    ...
    public static Error VehicleSchedulingConflict => Error.Conflict(
            "Vehicle_Overlapping_WorkOrder",
            "The vehicle already has an overlapping WorkOrder."
    );


    public static Error RepairTaskNotFound => Error.NotFound(
            "RepairTask.NotFound",
            "Repair task does not exist."
    );


    public static Error WorkOrderMustBeCompletedForInvoicing => Error.Conflict(
    ...
    public static Error LaborNotFound => Error.NotFound(
        code: "Employee.LaborNotFound",
