...
using MechanicShop.Application.Scheduling.Queries.GetDailyScheduleQuery;
using MechanicShop.Application.Workorders.Commands.AssignLabor;
using MechanicShop.Application.Workorders.Commands.CreateWorkOrder;
using MechanicShop.Application.Workorders.Commands.DeleteWorkOrder;
using MechanicShop.Application.Workorders.Commands.RelocateworkOrder;
using MechanicShop.Application.Workorders.Commands.UpdateOrderState;
using MechanicShop.Application.Workorders.Commands.UpdateWorkOrderRepairTasks;
using MechanicShop.Application.Workorders.DTOs;
using MechanicShop.Application.Workorders.Queries.GetWorkOrderById;
using MechanicShop.Application.Workorders.Queries.GetworkOrders;
...
public sealed class WorkOrdersController(ISender sender) : ApiController
{
    ...
    [EndpointDescription("Associates a labor definition with a specific work order." +
    ...
    [EndpointDescription("Updates the current state of the specified work order." +
        " Only users with the Manager role are authorized.")]
