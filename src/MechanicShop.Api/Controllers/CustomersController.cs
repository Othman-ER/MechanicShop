...
using MechanicShop.Application.Customers.Commands.CreateCustomer;
using MechanicShop.Application.Customers.Commands.RemoveCustomer;
using MechanicShop.Application.Customers.Commands.UpdateCustomer;
using MechanicShop.Application.Customers.DTOs;
using MechanicShop.Application.Customers.Queries.GetCustomerById;
using MechanicShop.Application.Customers.Queries.GetCustomers;
