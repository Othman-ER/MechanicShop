    ...
    : ITokenProvider
{
    ...
    public async Task<Result<TokenResponse>> GenerateJwtTokenAsync(ApplicationUserDTo user, CancellationToken ct = default)
    {
    ...
    private async Task<Result<TokenResponse>> CreateAsync(ApplicationUserDTo user, CancellationToken ct = default)
    {
