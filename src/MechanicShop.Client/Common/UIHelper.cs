...
{
    public static MarkupString GetStatusBadge(WorkOrderState? state) => state switch
    {
    ...
    public static MarkupString GetServiceBadge(string? serviceName) => serviceName switch
    {
    ...
    public static string FormatCurrency(decimal amount) => $"$ {amount:N0}";
}
