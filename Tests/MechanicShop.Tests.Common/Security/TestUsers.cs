...
{
    public static ApplicationUser Manager => new()
    {
    ...
    public static ApplicationUser Labor01 => new()
    {
    ...
    public static ApplicationUser Labor02 => new()
    {
    ...
    public static ApplicationUser Labor03 => new()
    {
    ...
    public static ApplicationUser Labor04 => new()
    {
