...
**Othman Er-Rouydi** *.NET Software Engineer | Domain Logic Enthusiast*

I am a developer based in **Martil, Morocco**, focused on building reliable systems using modern .NET practices. 

### 📬 Let's Connect:
* **Email:** [othman.errouydy@gmail.com](mailto:othman.errouydy@gmail.com)
* **GitHub:** [@Othman-ER](https://github.com/Othman-ER)
